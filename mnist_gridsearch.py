...
It implements the (limited) hyperparameter grid search
"""
...
def main():
    ...
    gauss_prior_params = [0, 1] # these are -log(sigma) values. make empty if u don't want gaussian priors
